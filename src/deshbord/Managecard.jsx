...
const OrderCard = ({data}) => {
    ...
    const updateOne=async()=>{
        try{
            const res =await axios.put(`https://grim-treat-11847.herokuapp.com/order/${data._id}`,{status:"add"})
                   ...
                   <div className="card mb-3" >
                    <div className="row g-0">
                        ...
                        <div className="card-body">
                            ...
                            <button onClick={updateOne} className="login-btn mb-3">add package</button>
